...
#[Route('/quiz-session/{quizSession}/results', name: 'app_quiz_session_results', methods: ['POST'])]
final class ResultsAction extends AbstractController
{
    public function __invoke(
        ...
        if (!$quizSession->getStatus()->isFinished()) {
            return $this->redirectToRoute('app_quiz_session_get_question', ['quizSession' => $session->getId()]);
        }
