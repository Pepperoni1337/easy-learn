 ...
 */
final class Version20251101125645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz_session_progress ADD current_level INT NOT NULL, ADD score INT NOT NULL, ADD current_streak INT NOT NULL, ADD max_streak INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz_session_progress DROP current_level, DROP score, DROP current_streak, DROP max_streak');
    }
}
